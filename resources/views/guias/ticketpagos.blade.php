...
<table class="centrar" style="width: 100%;">
 ...
 {{-- BLOQUE QR + TOTALES --}}
    ...
    <div id="qrTicket" style="padding: 10px;"> {!! DNS2D::getBarcodeHTML((string)($ticketact[0]->codigo ?? ''), 'QRCODE', 4, 4) !!}</div>
</td>
            ...
            <tr>
                ...
                <td style="text-align: left; margin-left: -50px;">ENTREGA EFECTIVO:</td>
