							...
							<div class="d-flex flex-column flex-row-fluid">
								...
								<div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
									...
									<div class="page-title me-5">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Guias generadas
										<!--begin::Description-->
...
<table class="table align-middle table-row-dashed fs-6 gy-5 dataTable" id="kt_ecommerce_sales_table" style="width: 100%;">
    ...
    <thead>
        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
            ...
            <th class="text-center min-w-200px " data-dt-column="3" rowspan="1" colspan="1"><div class="dt-column-header"><span class="dt-column-title">Direccion de entrega</span><span class="dt-column-order" role="button" aria-label="Status: Activate to sort" tabindex="0"></span></div></th>
