      ...
      <button type="submit" class="btn btn-primary">Filtrar</button>
                                ...
                                <div style="float:right">
                                    <button type="button" class="btn btn-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" >
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <form action="/guias/reportelistaexcel/" method="GET">

                                                <input type="text" value="{{ $id }}" name="ticketid" hidden>
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                               <form action="/guias/reportelistapdf" method="GET" target="_blank">
        ...
        <div class="table-responsive">
			...
			<table id="kt_ecommerce_report_shipping_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bold dataTable" style="width: 100%;">
				...
				<tr>
                            ...
                            <span class="badge text-bg-dark">{{ $envio->tipo }}</span>
